...
from scripts.preprocessing.preprocess_clinc import load_data_clinc
from model.loss_ctc import CTCLoss
import utils
    ...
    for i in range(5):
        for mode in ["pre-train", "init", "fine-tune"]:
            if mode == "pre-train":
                ...
                # 读取数据集
                train_iter, test_iter = load_data_clinc(batch_size, encoder_config, dataset_config, num_steps, True, is_roberta=net.is_roberta)
                ...
                # 读取数据集
                train_iter, test_iter = load_data_clinc(batch_size, encoder_config, dataset_config, num_steps, False, is_roberta=net.is_roberta)
                ...
                #     pc_path = '../data/preprocessed/clinc/labels_pc_bert.pkl'
                # else:
                #     pc_path = '../data/preprocessed/clinc/labels_pc_minilm.pkl'
            ...
            # 定义模块
            loss = CTCLoss(dataset_config["num_labels"])
