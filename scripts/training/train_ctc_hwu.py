    ...
    for i in range(5):
        for mode in ["pre-train", "init", "fine-tune"]:
            if mode == "pre-train":
                ...
                # 读取数据集
                train_iter, test_iter = load_data_hwu(batch_size, encoder_config, dataset_config, num_steps, True, is_roberta=net.is_roberta)
                ...
                # 读取数据集
                train_iter, test_iter = load_data_hwu(batch_size, encoder_config, dataset_config, num_steps, False, is_roberta=net.is_roberta)
