...
if __name__ == '__main__':
    ...
    dataset_config_path = "./../../config/ctc/banking.json"
    ...
    for i in range(5):
        for mode in ["pre-train", "init", "fine-tune"]:
            if mode == "pre-train":
                ...
                # 读取数据集
                train_iter, test_iter = load_data_banking(batch_size, encoder_config, dataset_config, num_steps, True,
                ...
                #     pc_path = '../data/preprocessed/banking/labels_pc_bert.pkl'
                # else:
                #     pc_path = '../data/preprocessed/banking/labels_pc_minilm.pkl'
