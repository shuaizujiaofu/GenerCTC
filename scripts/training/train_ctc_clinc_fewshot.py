    ...
    for i in range(5):
        for mode in ["pre-train", "init", "fine-tune"]:
            if mode == "pre-train":
                ...
                # 读取数据集
                train_iter, test_iter = load_data_clinc(batch_size, encoder_config, dataset_config, num_steps, True,
                                                          shot=fewshot_num,
                ...
                # 读取数据集
                train_iter, test_iter = load_data_clinc(batch_size, encoder_config, dataset_config, num_steps, False,
                                                          fewshot_num,
                                                          net.is_roberta)
